...
class _AllCarsScreenState extends State<AllCarsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: myCarsLoaded==false?FloatingActionButton(backgroundColor: StaticColors.blueColor,
          child: Icon(Icons.add,color: StaticColors.orangeColor,),
          onPressed: (){Get.to(()=>const UploadCarScreen());}):null,
      ...
      children: [
        ...
        Consumer<NormalSaleProvider>(builder: (builder, data, child) {
